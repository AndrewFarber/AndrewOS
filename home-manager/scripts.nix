...
in {
  home.packages = [
    ...
    (mkScript "andrewos-launch-chatgpt" { file = ../bin/andrewos-launch-chatgpt; runtimeInputs = [ pkgs.chromium ]; })
    ...
    (mkScript "andrewos-launch-github" { file = ../bin/andrewos-launch-github; runtimeInputs = [ pkgs.chromium ]; })
    (mkScript "andrewos-launch-linear" { file = ../bin/andrewos-launch-linear; runtimeInputs = [ pkgs.chromium ]; })
    ...
    (mkScript "andrewos-launch-notion" { file = ../bin/andrewos-launch-notion; runtimeInputs = [ pkgs.chromium ]; })
    (mkScript "andrewos-launch-proton-pass" { file = ../bin/andrewos-launch-proton-pass; runtimeInputs = [ pkgs.chromium ]; })
