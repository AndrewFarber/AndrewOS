...
PACKAGES_HELP = (
    ...
    "  /             Filter packages (type to narrow)\n"
    "  Enter / Esc   Confirm filter, browse results\n"
...
SEARCH_HELP = (
    ...
    "  g / G         Jump to first / last\n"
    "\n[bold]Actions[/bold]\n"
    "  Enter         Search (in input) / Detail (in table)\n"
    "  /             New search (refocus input)\n"
    "  Escape        Focus table / Go back\n"
    "  ?             Show this help\n"
    "  q             Go back"
)
